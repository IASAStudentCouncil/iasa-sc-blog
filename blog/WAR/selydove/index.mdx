...
> **Прим. ред.: Станом на 29 жовтня 2024 року в місті та на околицях ведуться тяжкі бої, більша його частина [окупована](https://deepstatemap.live/#6/49.4383200/32.0526800), фіксуються [розстріли](https://hromadske.ua/viyna/233590-rosiiany-rozstriliut-tsyvilnykh-u-selydovomu-za-iakykh-tryvaiut-boyi-ohp-pochav-rozsliduvannia) цивільного населення окупантами. 
> Станом на 30 жовтня 2024 року Селидове та села поблизу повністю окуповано.**
...
<MobileTOC sections={[
    {heading: "Колись давно…", subHeadings: []},
    {heading: "Історія однієї дівчини", subHeadings: []}
]}/>
