...
<ul className="images">
    ...
    <li className="top">
        <a href="https://i.imgur.com/8B0UUjm.jpg" alt="Місце для опису картинки"><img alt="Мем про сніг в КПІ" src="https://i.imgur.com/8B0UUjm.jpg" className="center" /></a>
        <p className="center"><b>Мем про сніг в КПІ</b></p>
    </li>
    <li className="middle">
        <img alt="Мем про сніг в КПІ" src="https://i.imgur.com/8B0UUjm.jpg" className="center" />
